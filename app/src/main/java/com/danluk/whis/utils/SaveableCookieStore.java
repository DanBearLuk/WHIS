...
public class SaveableCookieStore implements CookieStore {
    private static final String COOKIE_PREFS = "com.danluk.whis.cookieprefs";
    private static final String COOKIE_DOMAINS_STORE = "com.danluk.whis.CookieStore.domain";
    private static final String COOKIE_DOMAIN_PREFIX = "com.danluk.whis.CookieStore.domain_";
    private static final String COOKIE_NAME_PREFIX = "com.danluk.whis.CookieStore.cookie_";
     ...
     */
    public SaveableCookieStore(Context context) {
    ...
    public synchronized void add(URI uri, HttpCookie cookie) {
        ...
        for (HttpCookie cookie2 : cookies) {
            ...
            prefsWriter.putString(COOKIE_NAME_PREFIX + uri + cookie2.getName(),
                    encodeCookie(new SaveableCookie(cookie2)));
        }
     ...
     */
    protected String encodeCookie(SaveableCookie cookie) {
        if (cookie == null)
            return null;
    ...
    protected HttpCookie decodeCookie(String cookieString) {
        ...
        try {
            ...
            cookie = ((SaveableCookie) objectInputStream.readObject()).getCookie();
        } catch (IOException e) {
            //
